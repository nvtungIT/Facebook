          ...
          <View style={styles.modalBackground}>
            <View style={[styles.modalContainer]}>
              <View style={styles.modalTitleWrap}>
                <Text style={styles.modalTitle}>Bỏ chặn {user.name} ?</Text>
              </View>
              <Text style={styles.modalContent}>
                Nếu bạn bỏ chặn {user.name}, họ có thể xem Dòng thời gian của
                bạn hoặc liên hệ với bạn, tùy thuộc vào cài đặt của bạn.
              </Text>
              <Text style={styles.modalContent}>
                Có thể khôi phục các thẻ mà bạn và {user.name} đã thêm cho nhau
                trước đó
              </Text>
              <Text style={styles.modalContent}>
  ...
  return (
    <View style={styles.wrapper}>
      ...
      <Text style={styles.textNote}>
        ...
        nhóm, bắt đầu cuộc trò chuyện với bạn hay thêm bạn làm bạn bè. Điều này
        không bao gồm các ứng dụng, trò chơi hay nhóm mà cả bạn và người này đều
        tham gia.
      </Text>
      <Link to={{ screen: ScreenNames.addBlock }}>
        <View style={styles.linkAddBlock}>
          <Icon name="plus-square" style={styles.iconPlus} />
          <Text style={styles.textAddBlock}>THÊM VÀO DANH SÁCH CHẶN</Text>
        </View>
      </Link>
      {listBlock ? (
        listBlock.map((user, index) => <ItemBlock user={user} key={index} />)
      ) : (
        <Text></Text>
      )}
    </View>
