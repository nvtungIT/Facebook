...
export default function NameSetting({ navigation }) {
  ...
  const handleUpdate = async (data) => {
    try {
      ...
      const api =
        serverDomain + `user/update_name?token=${encodeURIComponent(token)}`
        ...
        <View style={styles.form}>
          ...
          <View style={styles.note}>
            <Text style={styles.textNote}>
              ...
              Nếu đổi tên trên Facebook, bạn không thể đổi lại trong 60 ngày.
              Đừng viết hoa khác thường, thêm bất kỳ dấu câu, ký tự hoặc từ ngẫu
              nhiên nào.
            </Text>
          </View>
